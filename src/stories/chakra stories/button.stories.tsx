...
export const WithButtonGroup: StoryFn<StoryProps> = (props) => (
  <ButtonGroup {...props}>
...
WithButtonGroup.argTypes = omit(buttonArgTypes, ["children", "isLoading"]);
WithButtonGroup.args = omit(defaultArgs, ["children", "isLoading"]);
