...
interface StoryProps extends ThemingProps<"Avatar"> {
  showBadge?: boolean;
}
...
export const Basic: StoryFn<StoryProps> = (props) => (
  <Avatar name="Dan Abrahmov" src="https://bit.ly/dan-abramov" {...props}>
    {props.showBadge && <AvatarBadge boxSize="1.25em" bg="green.500" />}
  </Avatar>
);

Basic.argTypes = getThemingArgTypes(theme, "Avatar");
Basic.args = {
  showBadge: false,
  size: "md",
};

export const Group: StoryFn<StoryProps> = (props) => (
  <AvatarGroup size={props.size} max={3}>
...
Group.argTypes = getThemingArgTypes(theme, "Avatar");
Group.args = {
  showBadge: false,
  size: "md",
};

export const CustomIcon: StoryFn<StoryProps> = (props) => (
  <AvatarGroup size={props.size} max={3}>
...
CustomIcon.argTypes = getThemingArgTypes(theme, "Avatar");
CustomIcon.args = {
  showBadge: false,
  size: "md",
};
